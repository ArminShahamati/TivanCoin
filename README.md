...
It's the starting point to interact with the tivancoin, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
```sh
# Run a node
$ node bin/tivancoin.js

# Run two nodes
$ node bin/tivancoin.js -p 3001 --name 1
$ node bin/tivancoin.js -p 3002 --name 2 --peers http://localhost:3001
...
```sh
# Build the image
$ docker build . -t tivancoin

# Run tivancoin in a docker
$ ./dockerExec.sh

# Run tivancoin in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run tivancoin in a docker options
$ ./dockerExec.sh -h
...
$ node bin/tivancoin.js -h
Usage: bin\tivancoin.js [options]
...
[![Twitter](https://img.shields.io/twitter/url/https/github.com/conradoqg/tivancoin.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20it%20out%3A%20tivancoin%20-%20a%20cryptocurrency%20implementation%20in%20less%20than%201500%20lines%20of%20code&url=%5Bobject%20Object%5D)

[![GitHub license](https://img.shields.io/badge/license-Apache%202-blue.svg)](https://raw.githubusercontent.com/conradoqg/tivancoin/master/LICENSE)
=======
# tivancoin - a cryptocurrency implementation in less than 1500 lines of code
