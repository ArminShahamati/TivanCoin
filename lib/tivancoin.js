...
module.exports = function tivancoin(host, port, peers, logLevel, name) {
    host = process.env.HOST || host || 'spinapp.ir';
    port = process.env.PORT || process.env.HTTP_PORT || port || 3006;
